      ...
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl
                          bg-accent/15 border border-accent/30 mb-4">
          ...
          <h1 className="text-2xl font-semibold text-gray-50">Ollama Chat</h1>
          <p className="text-sm text-gray-500 mt-1">Connectez-vous à votre espace</p>
        </div>

        {/* Carte */}
        <div className="bg-surface-2 border border-border rounded-2xl p-6 shadow-2xl">
          {error && (
            <div className="mb-4 px-3 py-2.5 bg-red-500/10 border border-red-500/20
                            rounded-lg text-red-400 text-sm">{error}</div>
          )}
